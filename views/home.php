...
<body class="font-sans text-gray-800 antialiased bg-gray-50 overflow-x-hidden">
    ...
    <section class="hero-section relative flex items-center justify-center text-white">
        ...
        <div class="hero-particles">
            ...
            <span style="left:20%; animation-duration:15s; animation-delay:2s;"></span>
            <span style="left:35%; animation-duration:18s; animation-delay:4s;"></span>
            <span style="left:50%; animation-duration:14s; animation-delay:1s;"></span>
            <span style="left:65%; animation-duration:16s; animation-delay:3s;"></span>
            <span style="left:80%; animation-duration:13s; animation-delay:5s;"></span>
            <span style="left:90%; animation-duration:17s; animation-delay:2.5s;"></span>
            <span style="left:45%; animation-duration:20s; animation-delay:6s;"></span>
        </div>

        <div class="absolute inset-0 z-[3]" style="background-image: radial-gradient(rgba(255,255,255,0.04) 1px, transparent 1px); background-size: 50px 50px;"></div>

        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10 pt-32 pb-20">
            <div data-aos="zoom-in" data-aos-duration="1000">
                
                <h1 class="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tight mb-8 leading-[1.05]">
                    <?= __('hero_title_1') ?><br>
                    <span class="hero-gradient-text"><?= __('hero_title_2') ?></span>
                </h1>
                
                <p class="text-lg md:text-xl text-blue-100/70 mb-14 max-w-2xl mx-auto font-light leading-relaxed">
                    <?= __('hero_subtitle_1') ?>
                    <span class="text-white font-semibold"><?= __('hero_subtitle_2') ?></span>
                </p>
                
                <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                    <button onclick="document.querySelector('#chat-toggle-btn').click()" class="btn-shine group relative px-10 py-5 rounded-2xl bg-gradient-to-r from-emerald-400 via-teal-500 to-cyan-500 text-white text-lg font-bold shadow-[0_0_60px_rgba(20,184,166,0.35)] hover:shadow-[0_0_90px_rgba(20,184,166,0.55)] transition-all duration-500 hover:-translate-y-1 border border-white/20">
                    ...
                    <a href="https://wa.me/48506304046" target="_blank" class="group px-8 py-5 rounded-2xl bg-green-500/20 backdrop-blur-xl border border-green-400/30 text-white text-lg font-semibold hover:bg-green-500/30 hover:border-green-400/50 transition-all duration-300 flex items-center gap-3 shadow-lg">
