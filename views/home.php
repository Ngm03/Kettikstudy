...
<body class="font-sans text-gray-800 antialiased bg-gray-50 overflow-x-hidden">
        ...
        <div class="flex flex-col h-full">
            ...
            <div class="flex-1 overflow-y-auto p-6">
                ...
                <div class="mt-8 p-4 rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100">
                    ...
                    <a href="#" onclick="openContactModal(event)" class="flex items-center gap-2 text-sm text-gray-700 mb-2 hover:text-green-600 transition">
    ...
    <section class="relative pt-32 pb-16 lg:pt-48 lg:pb-24 bg-gradient-to-b from-gray-50 to-white overflow-hidden">
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center mb-20">
                ...
                <div class="text-center lg:text-left" data-aos="fade-up" data-aos-duration="1000">
                    <div class="inline-flex items-center px-4 py-2 rounded-full bg-blue-50 border border-blue-100 text-blue-700 text-sm font-bold mb-6 tracking-wide">
                        🔥 <?= __("hero_badge_text") === "hero_badge_text" ? "Набор на 2026/2027 учебный год" : __("hero_badge_text") ?>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
                        ...
                        <a href="#" onclick="openContactModal(event)" class="px-8 py-4 rounded-xl bg-white border-2 border-gray-200 text-gray-700 hover:border-gray-300 hover:bg-gray-50 font-bold text-lg transition duration-200 flex items-center justify-center gap-2 shadow-sm">
    ...
    <!-- Блок статистики с тёмным градиентным фоном -->
    <section class="relative py-16 bg-gradient-to-br from-slate-900 via-blue-950 to-indigo-950 overflow-hidden">
        <div class="absolute top-0 left-1/4 w-72 h-72 rounded-full bg-blue-500/10 blur-3xl pointer-events-none"></div>
        <div class="absolute bottom-0 right-1/4 w-72 h-72 rounded-full bg-indigo-500/10 blur-3xl pointer-events-none"></div>
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4" id="stats-banner" data-aos="fade-up" data-aos-delay="100">
                <div class="stat-card bg-white/[0.06] backdrop-blur-xl rounded-2xl p-7 text-center border border-white/[0.1] shadow-xl">
                    <div class="text-4xl md:text-5xl font-black text-white mb-2 counter" data-target="8" data-suffix="+">0</div>
                    <div class="text-blue-300/80 text-xs font-semibold uppercase tracking-[0.2em]"><?= __('years_experience') ?></div>
                </div>
                <div class="stat-card bg-white/[0.06] backdrop-blur-xl rounded-2xl p-7 text-center border border-white/[0.1] shadow-xl">
                    <div class="text-4xl md:text-5xl font-black text-white mb-2 counter" data-target="700" data-suffix="+">0</div>
                    <div class="text-blue-300/80 text-xs font-semibold uppercase tracking-[0.2em]"><?= __('students') ?></div>
                </div>
                <div class="stat-card bg-white/[0.06] backdrop-blur-xl rounded-2xl p-7 text-center border border-white/[0.1] shadow-xl">
                    <div class="text-4xl md:text-5xl font-black text-white mb-2">100%</div>
                    <div class="text-blue-300/80 text-xs font-semibold uppercase tracking-[0.2em]"><?= __('admission') ?></div>
                </div>
                <div class="stat-card bg-white/[0.06] backdrop-blur-xl rounded-2xl p-7 text-center border border-white/[0.1] shadow-xl">
                    <div class="text-4xl md:text-5xl font-black text-white mb-2">24/7</div>
                    <div class="text-blue-300/80 text-xs font-semibold uppercase tracking-[0.2em]"><?= __('support') ?></div>
                </div>
            </div>
        </div>
    </section>
