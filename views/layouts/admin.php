...
<div class="admin-shell">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?= BASE_URL ?>/admin/community" class="nav-item <?php echo $page === 'community' ? 'active' : ''; ?>">
            ...
            <a href="<?= BASE_URL ?>/admin/notifications" class="nav-item <?php echo $page === 'notifications' ? 'active' : ''; ?>">
