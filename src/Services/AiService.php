...
ПРИМЕЧАНИЕ ПО DATA:
- В массиве "data" всегда возвращай ВСЕ накопленные значения. Если значение неизвестно, передавай null или пустую строку. Не стирай то, что уже известно (см. раздел ТВОЕ СОСТОЯНИЕ).сса) или ВУЗ (Бакалавриат/Магистратура, обычно платно).
